...
sys.path.insert(0, os.path.abspath('../'))
sys.path.insert(0, os.path.abspath('../django_states'))
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'settings')
print(os.path.abspath('../django_states'))
...
project = u"django-states3"
copyright = u"2019, ulam.io"
author = 'Ulam Labs'
...
latex_documents = [
    (
        "index",
        "django-states.tex",
        u"django-states Documentation",
        u"Jonathan Slenders, Gert Van Gool",
        "manual",
    ),
]
