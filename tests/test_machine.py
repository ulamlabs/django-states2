...
from .models import DjangoStateClass, DjangoState2Class, DjangoStateLogClass
from .statemachine import TestMachine
...
class StateModelTestCase(TransactionTestCase):
    ...
    def test_classmethods(self):
        self.assertEqual(
            DjangoStateClass.get_state_model_name(), "django_states.DjangoStateClass"
        )
